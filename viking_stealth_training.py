...
def main():
    ...
    parser.add_argument(
        '--lvl', '-l', help='your current sneak skill level', type=int, default=0)
    parser.add_argument(
    ...
    if debug:
        ...
        print('sneak stamina drain rate:', drain_rate, '/sec.')
    ...
    while ((time.time() - stealth_training_start) / 60) < longest_foor_duration:
        ...
        if one_min_interval > 60:
            ...
            elapsed_time = (current_time - stealth_training_start) / 60
